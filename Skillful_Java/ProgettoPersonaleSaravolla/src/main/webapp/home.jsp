...
<body>
	...
	if(request.getParameter("logout") != null){
		sessione.removeAttribute("user_id");
		sessione.removeAttribute("pfp");
		sessione.removeAttribute("role");
		response.sendRedirect("login.jsp");
	} else if(sessione.getAttribute("user_id") == null){
		response.sendRedirect("login.jsp");
	} else {
    ...
    <div id="header">
        ...
        <div id="rightHeader">
            <div id="leaderboardButton">
                <a href="leaderboard.jsp" style="margin-right: 10px; width: 50px; height: 50px"><img class="img" src="assets/icons/leaderboardButton/leaderboard0.png" width=50px height=50px></a>
            </div>
            ...
            <div id="profileIcon">
            	<a href='viewProfile.jsp?userid=<%= user_id %>'><img id="pfp" src="<%= profilePic %>"></a>
            </div>
